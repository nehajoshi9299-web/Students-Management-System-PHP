...
<div class="login-box">
  ...
  <div class="login-box-body">
    ...
    if (isset($_POST['submit'])) {
      ...
      // Check for Admin login (no need for database)
      if ($email == "admin@gmail.com" && $password == "admin") {
        $_SESSION['role'] = 'Admin';
        $_SESSION['user'] = 'Admin'; // You can change this to actual admin details
        header("Location: admin.php");  // Redirect directly to Admin page
        exit();
      }
      ...
      if ($result->num_rows > 0) {
        ...
        header("Location: ./"); // Redirect to home page after login
      } else {
